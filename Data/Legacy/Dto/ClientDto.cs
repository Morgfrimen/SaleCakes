...
public record ClientDto
{
    ...
    public ClientDto(string clientName, string clientSurname, string clientPatronymic, string phone, string email, IEnumerable<Guid> ordersId)
    {
    ...
    public IEnumerable<Guid> OrdersId { get; }
}